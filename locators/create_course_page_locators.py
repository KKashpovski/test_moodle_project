...
class CreateCourseImagesLocators:
    OPEN_IMAGE_MENU_BUTTON = (By.CSS_SELECTOR, "a[role='button'] > .fa.fa-file-o.fa-fw.icon")
    DOWNLOAD_FILES_BY_URL = (By.CSS_SELECTOR, "div:nth-of-type(5) > .nav-link > .fp-repo-name")
    ...
    COURSE_INFO_ICON = (By.CSS_SELECTOR, ".collapsed.coursebox.first.odd a[title='Описание'] > i[title='Описание']")
...
class CreateCourseTagsLocators:
    ...
    TAGS_FOR_COURSE = (By.XPATH, "/html//div[@id='fitem_id_tags']/div[2]//input[@role='combobox']")
